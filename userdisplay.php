...
$stmt = $pdo->prepare('SELECT id, fullname, address, age, nic FROM users WHERE id = ? LIMIT 1');
...
<head>
    ...
    <title>Sri Lankan Election Voting System - Details</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="voting-card">
            ...
            <div class="card-body">
                ...
                <div class="voter-info">
                    <div class="info-grid">
                        <div class="info-card">
                            <div class="info-icon icon-maroon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-value"><?php echo h($user['nic'] ?? ''); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-value"><?php echo h($user['fullname'] ?? ''); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-value"><?php echo isset($user['age']) && $user['age'] !== null ? h($user['age']) . ' years' : '-'; ?></div>
                            </div>
                        </div>
                        ...
                        <div class="info-card">
                            <div class="info-icon icon-yellow">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <circle cx="12" cy="10" r="3" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                            <div class="info-content">
                                <div class="info-label">Address</div>
                                <div class="info-value"><?php echo h($user['address'] ?? ''); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="eligibility-notice">
                    ...
                    <div class="eligibility-text">
                        ...
                        <p>You are registered and eligible to cast your vote</p>
                    </div>
                </div>
                ...
                <div class="action-buttons">
                    ...
                    <button class="proceed-button" onclick="window.location.href='biohtml.php'">
