...
<head>
    ...
    <title>Sri Lankan Election Voting System - Fingerprint Verified</title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card-body">
                ...
                <div class="success-section">
                    ...
                    <div class="success-text">
                        <h3>Fingerprint Verified Successfully</h3>
                        <p>Identity confirmed. You may proceed to vote.</p>
                    </div>
                </div>
                ...
                <div class="action-buttons">
                    ...
                    <button class="proceed-button" onclick="window.location.href='selectparty.php'">
