...
<html>
<head>
    <title>Sri Lankan Election Voting System - Confirm Vote</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="voting-card">
            <div class="alert-header">
                ...
                <div class="alert-text">
                    ...
                    <p>Please review your selected choices before submitting</p>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="summary-box">
                    ...
                    <div class="selection-item">
                        <div class="selection-logo logo-green">
                            ...
                            <div class="selection-info">
                                <div class="selection-label">Political Party</div>
                                <div class="selection-value"><?php echo $candidate['party_name'] ? h($candidate['party_name']) : 'Unknown'; ?></div>
                            </div>
                    </div>
                    ...
                    <div class="selection-item">
                        ...
                        <div class="selection-info">
                            <div class="selection-label">Selected Candidate</div>
                            <div class="selection-value"><?php echo h($candidate['name']); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="warning-box">
                    ...
                    <div class="warning-text">
                        ...
                        <div class="warning-message">Once you submit your vote, it cannot be changed. Please review all details carefully.</div>
                    </div>
                </div>
                ...
                <form method="post" action="vote.php" class="action-buttons" style="display:flex; gap:15px; align-items:center;">
                    ...
                    <input type="hidden" name="candidate_id" value="<?= (int)$candidate_id ?>">
                    <button class="submit-button active" id="submitBtn" type="submit">
                        Submit My Vote
                    </button>
                </form>
